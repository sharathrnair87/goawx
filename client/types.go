...
type SettingsAzureADOauth2 struct {
	SOCIAL_AUTH_AZUREAD_OAUTH2_CALLBACK_URL     string      `json:"SOCIAL_AUTH_AZUREAD_OAUTH2_CALLBACK_URL"`
	SOCIAL_AUTH_AZUREAD_OAUTH2_KEY              string      `json:"SOCIAL_AUTH_AZUREAD_OAUTH2_KEY"`
	SOCIAL_AUTH_AZUREAD_OAUTH2_SECRET           string      `json:"SOCIAL_AUTH_AZUREAD_OAUTH2_SECRET"`
	SOCIAL_AUTH_AZUREAD_OAUTH2_ORGANIZATION_MAP interface{} `json:"SOCIAL_AUTH_AZUREAD_OAUTH2_ORGANIZATION_MAP"`
	SOCIAL_AUTH_AZUREAD_OAUTH2_TEAM_MAP         interface{} `json:"SOCIAL_AUTH_AZUREAD_OAUTH2_TEAM_MAP"`
}

type SettingsGithubOauth2 struct {
	SOCIAL_AUTH_GITHUB_KEY              string      `json:"SOCIAL_AUTH_GITHUB_KEY"`
	SOCIAL_AUTH_GITHUB_SECRET           string      `json:"SOCIAL_AUTH_GITHUB_SECRET"`
	SOCIAL_AUTH_GITHUB_ORGANIZATION_MAP interface{} `json:"SOCIAL_AUTH_GITHUB_ORGANIZATION_MAP"`
	SOCIAL_AUTH_GITHUB_TEAM_MAP         interface{} `json:"SOCIAL_AUTH_GITHUB_TEAM_MAP"`
}

type SettingsGithubEnterpriseOauth2 struct {
	SOCIAL_AUTH_GITHUB_ENTERPRISE_URL              string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_URL"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_API_URL          string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_API_URL"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_KEY              string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_KEY"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_SECRET           string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_SECRET"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORGANIZATION_MAP interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORGANIZATION_MAP"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_MAP         interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_MAP"`
}

type SettingsGithubEnterpriseOrgOauth2 struct {
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_URL              string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_URL"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_API_URL          string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_API_URL"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_KEY              string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_KEY"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_SECRET           string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_SECRET"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_NAME             string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_NAME"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_ORGANIZATION_MAP interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_ORGANIZATION_MAP"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_TEAM_MAP         interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_TEAM_MAP"`
}

type SettingsGithubEnterpriseTeamOauth2 struct {
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_URL              string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_URL"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_API_URL          string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_API_URL"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_KEY              string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_KEY"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_SECRET           string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_SECRET"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_ID               string      `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_ID"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_ORGANIZATION_MAP interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_ORGANIZATION_MAP"`
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_TEAM_MAP         interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_TEAM_MAP"`
}

type SettingsGithubOrgOauth2 struct {
	SOCIAL_AUTH_GITHUB_ORG_KEY              string      `json:"SOCIAL_AUTH_GITHUB_ORG_KEY"`
	SOCIAL_AUTH_GITHUB_ORG_SECRET           string      `json:"SOCIAL_AUTH_GITHUB_ORG_SECRET"`
	SOCIAL_AUTH_GITHUB_ORG_NAME             string      `json:"SOCIAL_AUTH_GITHUB_ORG_NAME"`
	SOCIAL_AUTH_GITHUB_ORG_ORGANIZATION_MAP interface{} `json:"SOCIAL_AUTH_GITHUB_ORG_ORGANIZATION_MAP"`
	SOCIAL_AUTH_GITHUB_ORG_TEAM_MAP         interface{} `json:"SOCIAL_AUTH_GITHUB_ORG_TEAM_MAP"`
}

type SettingsGithubTeamOauth2 struct {
	SOCIAL_AUTH_GITHUB_TEAM_KEY              string      `json:"SOCIAL_AUTH_GITHUB_TEAM_KEY"`
	SOCIAL_AUTH_GITHUB_TEAM_SECRET           string      `json:"SOCIAL_AUTH_GITHUB_TEAM_SECRET"`
	SOCIAL_AUTH_GITHUB_TEAM_ID               string      `json:"SOCIAL_AUTH_GITHUB_TEAM_ID"`
	SOCIAL_AUTH_GITHUB_TEAM_ORGANIZATION_MAP interface{} `json:"SOCIAL_AUTH_GITHUB_TEAM_ORGANIZATION_MAP"`
	SOCIAL_AUTH_GITHUB_TEAM_TEAM_MAP         interface{} `json:"SOCIAL_AUTH_GITHUB_TEAM_TEAM_MAP"`
}

type SettingsGoogleOauth2 struct {
	SOCIAL_AUTH_GOOGLE_OAUTH2_KEY                  string      `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_KEY"`
	SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET               string      `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET"`
	SOCIAL_AUTH_GOOGLE_OAUTH2_WHITELISTED_DOMAINS  string      `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_WHITELISTED_DOMAINS"`
	SOCIAL_AUTH_GOOGLE_OAUTH2_AUTH_EXTRA_ARGUMENTS string      `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_AUTH_EXTRA_ARGUMENTS"`
	SOCIAL_AUTH_GOOGLE_OAUTH2_ORGANIZATION_MAP     interface{} `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_ORGANIZATION_MAP"`
	SOCIAL_AUTH_GOOGLE_OAUTH2_TEAM_MAP             interface{} `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_TEAM_MAP"`
}
